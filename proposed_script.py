...
parser.add_argument("-b","--batch_size", type=int, default=256, help="Size of each batch")
...
if __name__ == "__main__":
    ...
    train_batches  =  sp(graph_no_new_node, args.batch_size, basic_sampler, seed = train_seed)
    
    print("tbd..: ", train_batches)
    # dummy_batches = sp(graph_no_new_node, args.batch_size, basic_sampler, seed = valid_seed)


    valid_batches = sp(graph_no_new_node, args.batch_size, basic_sampler, seed = valid_seed)
    # print("t..")
    test_batches = sp(graph_no_new_node, args.batch_size, basic_sampler, seed = test_seed)
    # print("t1..")
